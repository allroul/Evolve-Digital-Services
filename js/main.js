$(document).ready(function () {
    /*Clients PopUps*/
    const clientsSeeMoreBtns = document.querySelectorAll(
    ...
    for (clientsSeeMoreBtn of clientsSeeMoreBtns) {
        clientsSeeMoreBtn.addEventListener('click', (e) => {
            e.target
                .closest('div')
                .querySelector('.client-pop-up').style.overflowY = 'auto'
            e.target
                .closest('div')
                .querySelector('.client-pop-up')
                .classList.add('_open')
            e.target
                .closest('div')
    ...
    async function formSend(e) {
        ...
        if (error === 0) {
            ...
            alert(
                ' Oooops! Something is missing. Make sure all details are there!',
            )
        }
    }
